                ...
                <div class="col-xxl-12">
                    <div class="login-wrapper d-flex">
                                ...
                                <form method="post" action="/recruiter/register/mail-verification" id="regForm"
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input oninput="this.className = ''" class="form-control" type="email"
                                                id="email" name="email" autocomplete="off"
                                                placeholder="example@yourdomain.com" required />
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="mobile_code">Phone Number</label>
                                            <input oninput="this.className = ''" class="form-control" type="number"
                                                id="mobile_code" name="mobile" required />
                                        </div>
                                        <div class="form-group position-relative" id="show_hide_password">
                                            <label for="password" class="form-label">Password</label>
                                            <div class="input-group">
                                                <input oninput="this.className = ''" type="password" id="password"
                                                    name="password" autocomplete="off" class="form-control" required />
                                        ...
                                        <div class="form-group position-relative" id="show_hide_password2">
                                            ...
                                            <div class="input-group">
                                                <input oninput="this.className = ''" type="password" id="password2"
                                                    name="password2" autocomplete="off" class="form-control"
                                                    required />
                                                <div class="input-group-addon">
                                                    <a href="javascript:void(0)">
                                                        <i class="far slash-icon fa-eye-slash" aria-hidden="true"></i>
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input oninput="this.className = ''" class="form-control" type="text"
                                                id="companyName" name="company_name" autocomplete="off" required />
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="industryType">Industry Type</label>
                                            <select id="industryType" class="form-select"
                                                aria-label="Default select example" name="industry_type">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="numberOfEmployees">Number Of
                                                Employees</label>
                                        ...
                                        <div class="form-group custom-select2">
                                            ...
                                            <svg width="19" height="19" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <path d="M5 7.5L10 12.5L15 7.5" stroke="#343a40"
                                                    stroke-width="1.66667" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                            <select class="form-select" aria-label="Default select example"
                                                id="countries" name="location">
                                                ...
                                                <option value="BN" data-capital="Bandar Seri Begawan">
                                                    Brunei Darussalam
                                                </option>
                        ...
                        <div class="login-image">
                            <img src="{{ asset('img/auth/reg-image.png') }}" class="img-fluid"
