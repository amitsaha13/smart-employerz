...
<title>All Jobs | {{ config('app.name') }}</title>
    ...
    <div class="dashboard custom-space pt-0 pb-0">
        <div class="all-plans mb-0 pb-0">
            <div class="row no-gutters">
                <div class="col-md-12">
                    <div class="all-tabs">
                        <ul class="nav nav-pills all-jobs-tab" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="active-jobs-tab" data-bs-toggle="pill"
                                    data-bs-target="#active-jobs" type="button" role="tab" aria-controls="active-jobs"
                                    aria-selected="true">
                                    <span>Active Jobs</span> <span class="badge">100</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="schedule-job-tab" data-bs-toggle="pill"
                                    data-bs-target="#schedule-job" type="button" role="tab"
                                    aria-controls="schedule-job" aria-selected="false">
                                    <span>Schedule Jobs</span> <span class="badge">76</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="expired-job-tab" data-bs-toggle="pill"
                                    data-bs-target="#expired-job" type="button" role="tab" aria-controls="expired-job"
                                    aria-selected="false">
                                    <span>Expired Jobs</span> <span class="badge">19</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="draft-job-tab" data-bs-toggle="pill"
                                    data-bs-target="#draft-job" type="button" role="tab" aria-controls="draft-job"
                                    aria-selected="false">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="active-jobs" role="tabpanel"
                                aria-labelledby="active-jobs-tab" tabindex="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="links">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M16 18V8" stroke="#667085"
                                                                        stroke-width="1.67" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path d="M10 18V2" stroke="#667085"
                                                                        stroke-width="1.67" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path d="M4 18V12" stroke="#667085"
                                                                        stroke-width="1.67" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                </svg>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="modal-pointer" data-bs-toggle="modal"
                            ...
                            <div class="tab-pane fade" id="schedule-job" role="tabpanel"
                                aria-labelledby="schedule-job-tab" tabindex="0">
                                <div class="filter-section">
                                    <div class="search-filed">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                                                    ...
                                                    <ul class="links">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                    height="20" viewBox="0 0 20 20" fill="none">
                                                                    <path d="M13 12.0001L18 7.00004L13 2" stroke="#667085"
                                                                        stroke-width="2" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                    <path
                                                                        d="M2 18.0001V11C2 9.93916 2.42143 8.92173 3.17158 8.17158C3.92173 7.42143 4.93916 7 6.00003 7H18.0001"
                                                                        stroke="#667085" stroke-width="1.67"
                                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                                </svg>
                                                            </a>
                                                            ...
                                                            <a href="#">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        stroke="#667085" stroke-width="1.67"
                                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                                    <path d="M1 1L19 19" stroke="#667085"
                                                                        stroke-width="1.67" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                </svg>
                                                            </a>
                            ...
                            <div class="tab-pane fade" id="expired-job" role="tabpanel"
                                aria-labelledby="expired-job-tab" tabindex="0">
                                <div class="filter-section">
                                    <div class="search-filed">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                                                            ...
                                                            <a href="#">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                    ...
                                                                    <g clip-path="url(#clip0_589_13964)">
                                                                        <path d="M0.832031 3.33203V8.33203H5.83203"
                                                                            stroke="#667085" stroke-width="1.67"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                        <path
                                                                            d="M2.9237 12.5C3.46403 14.0337 4.48814 15.3502 5.84174 16.2512C7.19535 17.1522 8.8051 17.5889 10.4285 17.4954C12.0518 17.402 13.6008 16.7835 14.8421 15.7332C16.0834 14.6828 16.9497 13.2575 17.3105 11.672C17.6714 10.0865 17.5071 8.42667 16.8426 6.94262C16.178 5.45857 15.0491 4.2307 13.6261 3.44401C12.203 2.65732 10.5628 2.35442 8.9526 2.58097C7.34241 2.80751 5.84946 3.55122 4.6987 4.70004L0.832031 8.33337"
                                                                            stroke="#667085" stroke-width="1.67"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                    </g>
                            ...
                            <div class="tab-pane fade" id="draft-job" role="tabpanel"
                                aria-labelledby="draft-job-tab" tabindex="0">
                                <div class="filter-section">
                                    <div class="search-filed">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
