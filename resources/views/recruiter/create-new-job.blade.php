            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group mx-md-4">
                  ...
                  <input type="text" class="form-control" id="jobTitle" aria-describedby="jobTitle" name="job_title"
                    required />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group ms-md-4">
                  <label class="form-label" for="jobLevel">Job
                    Level</label>
                  <select class="form-select" name="job_level" id="job_level" aria-label="Default select example"
                    required>
                ...
                <div class="form-group me-md-4">
                  ...
                  <div class="d-flex gap-3">
                    <select class="form-select" name="min_experience" id="min_experience"
                      ...
                      @for ($i = 0; $i <= settings('MAX_EXPERIENCE'); $i++) <option value="{{ $i }}">
                    ...
                    <select class="form-select" name="max_experience" id="max_experience"
                      ...
                      @for ($i = 1; $i <= settings('MAX_EXPERIENCE'); $i++) <option value="{{ $i }}">
                        {{ numberToWord($i) }}</option>
                        @endfor
                    </select>
                  </div>
        ...
        <div class="row mb-4">
          <div class="col-xl-12">
            <div class="title-bar-with-btn mb-4">
              ...
              <button type="button" onclick="generateWithAI()"><svg xmlns="http://www.w3.org/2000/svg" width="16"
              ...
              <div class="col-md-12">
                <div class="form-group mx-md-4">
                  ...
                  <div class="form-floating">
                    <textarea class="form-control" name="job_description" id="jobDescription"
                      required>Descriptions</textarea>
                  </div>
            ...
            <div class="col-md-12">
              <div class="form-group custom-select2 mx-md-4">
                ...
                <select class="form-select" aria-label="Default select example" name="job_location" required
                  id="countries">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group ms-md-4">
                  ...
                  <input type="text" placeholder="Education Management" class="form-control" name="company_industry"
                    id="CompanyIndustry" aria-describedby="CompanyIndustry" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group me-md-4">
                  <label for="jobFunction" class="form-label">Job function</label>
                  <input type="text" placeholder="Job function" class="form-control" name="job_function"
                    id="jobFunction" aria-describedby="jobFunction" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-5 col-lg-6">
                <div class="form-group ms-md-4">
                  ...
                  <input type="text" placeholder="Full Time" class="form-control" id="employmentType"
                    name="employment_type" aria-describedby="FullTime" />
                </div>
              </div>
              <div class="col-md-7 col-lg-6">
                <div class="form-group me-md-4">
                  <label for="writeHere" class="form-label">Specialized or Experience Area</label>
                  <input type="text" placeholder="Write Here" class="form-control" name="specialization"
                    id="specialization" aria-describedby="writeHere" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row mb-4">
              <div class="col-md-6 col-lg-3">
                <div class="form-group ms-md-4">
                  ...
                  <input type="text" placeholder="Minimum" class="form-control" name="min_salary" id="min_salary"
              ...
              <div class="col-md-6 col-lg-3">
                <div class="form-group me-md-4 me-lg-0">
                  ...
                  <input type="text" placeholder="Maximum" class="form-control" name="max_salary" id="max_salary"
              ...
              <div class="col-md-12 col-lg-6">
                <div class="form-group me-md-4 ms-md-4 ms-lg-0">
                  ...
                  <select class="form-select" id="currency" name="currency" aria-label="Default select example">
            ...
            <div class="row mb-4">
              <div class="col-md-12">
                <div class="form-check form-switch ms-md-4">
                  <input class="form-check-input me-2" type="checkbox" role="switch" name="company_info_visibility"
                    id="flex2SwitchCheckChecked" checked />
                  <span class="d-block">Hide Company Information</span>
                  <label class="form-check-label ps-1" for="flex2SwitchCheckChecked">I’m open and available for
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group mx-md-4">
                  ...
                  <input type="text" class="form-control" id="alternative_company_name" aria-describedby="jobTitle"
        ...
        <div class="row mb-4">
          <div class="col-md-12">
            <div class="form-group me-md-4">
              ...
              <select class="form-select" id="IndustryExpert" name="business_area" aria-label="Default select example">
          ...
          <div class="col-md-12">
            <div class="form-group me-md-4">
              ...
              <input type="text" class="form-control" id="educational_requirements" name="educational_requirements"
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label class="form-label" for="Workplace">Workplace /
                Workstation</label>
              <select class="form-select" id="workplace" name="workplace" aria-label="Default select example">
          ...
          <div class="col-md-6">
            <div class="form-group me-md-4">
              ...
              <input type="text" class="form-control" id="nationality" name="nationality" aria-describedby="skillOne" />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group me-md-4">
              ...
              <div class="d-flex gap-3">
                ...
                <input type="number" placeholder="18" class="form-control" name="min_age" id="min_age"
                  aria-describedby="min_age" />

                <input type="number" placeholder="59" class="form-control" name="max_age" id="max_age"
                  aria-describedby="max_age" />
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group me-md-4">
              <label for="Certifications" class="form-label">Training &
                Certification</label>
              <input type="text" class="form-control" name="training_certification" id="training_certification"
