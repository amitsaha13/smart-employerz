...
<title>Dashboard | Smartemployerz</title>
      ...
      <a href="#" class="text-decoration-none">
        <div class="card-body bg-active">
          <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="11" y="17" width="24" height="11.4286" rx="5.71429" fill="white" />
            <circle cx="28.716" cy="22.716" r="4.57143" fill="#62A86E" />
          </svg>
      ...
      <a href="#" class="text-decoration-none">
        <div class="card-body bg-pending">
          <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M25.5 18V20L23 22.5L25.5 25V27H20.5V26.5V25L23 22.5L20.5 20V18H25.5Z" fill="white" />
            <path
            ...
            <path
              ...
              fill="white" />
            <line y1="-0.5" x2="4.01145" y2="-0.5" transform="matrix(0.998656 0.0518335 -0.0522668 0.998633 13.0195 14)"
              stroke="white" />
        ...
        <div class="card-body bg-expired">
          <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="white" />
            <path d="M23.5607 22.2229H22.9364L22 17.5409C22 15.0448 24.8092 15.9805 24.4971 17.5409L23.5607 22.2229Z"
              fill="#FF5F57" />
  ...
  <div class="row no-gutters">
    <div class="col-md-12">
      <div class="applicants-bar">
        ...
        <a href="./all-applicants.html" class="text-decoration-none">See All
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M4.16797 10.0013H15.8346M15.8346 10.0013L10.0013 4.16797M15.8346 10.0013L10.0013 15.8346"
            ...
            <div class="applicants-wrapper">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="applicants-image">
                      <img src="{{ asset('img/dashboard/applicants/applicants-1.png') }}" alt="Applicants - 1"
                        class="img-fluid" />
                    </div>
                    <div class="details">
                      <h3>Jason Ruly</h3>
              ...
              <a href="#" class="text-decoration-none">
                <div class="card">
                  <div class="card-body">
                    <div class="applicants-image">
                      <img src="{{ asset('img/dashboard/applicants/applicants-2.png') }}" alt="Applicants - 2"
                        class="img-fluid" />
                    </div>
                    <div class="details">
                      <h3>Jason Ruly</h3>
              ...
              <a href="#" class="text-decoration-none">
                <div class="card">
                  <div class="card-body">
                    <div class="applicants-image">
                      <img src="{{ asset('img/dashboard/applicants/applicants-3.png') }}" alt="Applicants - 3"
                        class="img-fluid" />
                    </div>
                    <div class="details">
                      <h3>Jason Ruly</h3>
              ...
              <a href="#" class="text-decoration-none">
                <div class="card">
                  <div class="card-body">
                    <div class="applicants-image">
                      <img src="{{ asset('img/dashboard/applicants/applicants-4.png') }}" alt="Applicants - 4"
                        class="img-fluid" />
                    </div>
                    <div class="details">
                      <h3>Jason Ruly</h3>
              ...
              <a href="#" class="text-decoration-none">
                <div class="card">
                  <div class="card-body">
                    <div class="applicants-image">
                      <img src="{{ asset('img/dashboard/applicants/applicants-5.png') }}" alt="Applicants - 5"
                        class="img-fluid" />
                    </div>
                    <div class="details">
                      <h3>Jason Ruly</h3>
    ...
    <div class="col-md-12">
      <div class="all-tabs">
        <div class="see-all-links">
          <a href="./all-jobs.html" class="text-decoration-none">See All
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M4.16797 10.0013H15.8346M15.8346 10.0013L10.0013 4.16797M15.8346 10.0013L10.0013 15.8346"
                stroke="#344054" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
            </svg></a>
        ...
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="active-jobs-tab" data-bs-toggle="pill" data-bs-target="#active-jobs"
              type="button" role="tab" aria-controls="active-jobs" aria-selected="true">
              <span>Active Jobs</span> <span class="badge">100</span>
            </button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="recruitment-plan-tab" data-bs-toggle="pill" data-bs-target="#recruitment-plan"
              type="button" role="tab" aria-controls="recruitment-plan" aria-selected="false">
              Recruitment Plan
            </button>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
                ...
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="d-flex gap-1">
                      <span>Applied</span>
                      <span data-bs-toggle="tooltip" data-bs-title="Lorem Ipsum">
                        ...
                        <li>
                          <a href="#">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path d="M16 18V8" stroke="#667085" stroke-width="1.67" stroke-linecap="round"
                                stroke-linejoin="round" />
                              <path d="M10 18V2" stroke="#667085" stroke-width="1.67" stroke-linecap="round"
                                stroke-linejoin="round" />
                              <path d="M4 18V12" stroke="#667085" stroke-width="1.67" stroke-linecap="round"
                                stroke-linejoin="round" />
                            </svg>
                          </a>
                        </li>
                          ...
                          <a class="modal-pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                              ...
                              <path
                                ...
                                stroke="#667085" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M7.16016 11.2578L12.8518 14.5745" stroke="#667085" stroke-width="1.67"
                                stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M12.8435 5.42578L7.16016 8.74245" stroke="#667085" stroke-width="1.67"
                                stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                          </a>
                        </li>
          ...
          <div class="tab-pane fade" id="recruitment-plan" role="tabpanel" aria-labelledby="recruitment-plan-tab"
            tabindex="0">
            <div class="table-responsive">
              <table class="table">
                <thead>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-lg-6 col-xl-4 px-2">
      <div class="card">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur. Viverra aliquet dolor eu mauris leo
          tempus orci augue sed.
        </p>
    ...
    <div class="col-lg-6 col-xl-4 px-2">
      <div class="card">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur. Viverra aliquet dolor eu mauris leo
          tempus orci augue sed.
          Sed tortor Lorem ipsum dolor sit amet consectetur. Viverra aliquet dolor eu
          mauris leo tempus orci
          augue sed. Sed tortor
        </p>
        <a href="#">Connect LinkedIn</a>
      </div>
    </div>
