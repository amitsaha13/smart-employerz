                        ...
                        <a href="#" class="text-decoration-none">
                            <div class="card-body bg-pending">
                                <svg width="46" height="46" viewBox="0 0 46 46" fill="none"
                                    ...
                                    <path d="M25.5 18V20L23 22.5L25.5 25V27H20.5V26.5V25L23 22.5L20.5 20V18H25.5Z"
                                        fill="white" />
                                    <path
                    ...
                    <div class="col-md-12">
                        <div class="all-tabs">
                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="active-jobs-tab" data-bs-toggle="pill"
                                        data-bs-target="#active-jobs" type="button" role="tab"
                                        aria-controls="active-jobs" aria-selected="true">
                                        <span>Active Jobs</span> <span class="badge">100</span>
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="recruitment-plan-tab" data-bs-toggle="pill"
                                        data-bs-target="#recruitment-plan" type="button" role="tab"
                                        aria-controls="recruitment-plan" aria-selected="false">
                                        Recruitment Plan
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="recruitment-plan" role="tabpanel"
                                    aria-labelledby="recruitment-plan-tab" tabindex="0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
