                                                    ...
                                                    <div class="description">
                                                        ...
                                                        <div class="content">
                                                            <h2>{{ $application->first_name }} {{ $application->last_name }}
                                                                <span>({{ calculateAge($application->dob) }})</span>
                                                            </h2>
                                                            <h3>{{ $application->current_job_detail->designation }}
                                                                <span>({{ $application->current_job_detail->start_date }})
                                                                    At,
                                                                    {{ $application->current_job_detail->company }}</span>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div class="location">
