                                                    ...
                                                    <div class="content">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="15"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="black" mask="url(#path-2-inside-1_1088_12133)" />
                                                        </svg>
                                                        <span>$ 1,000</span>
                                                    </div>
                                                    <div class="content">
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-6.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-7.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-8.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-9.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-10.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-11.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="description">
                                                    <div class="image">
                                                        <img src="{{ asset('img/dashboard/applicants/applicants-12.png') }}"
                                                            alt="Applicants - 1" class="img-fluid" />
                                                    </div>
                                                    <div class="content">
                                                        <h2>Jason Ruly <span>(30)</span></h2>
